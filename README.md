...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ll-Hunoter-ll/WhatsAsena)

### The Hard Method
```js
git clone https://github.com/ll-Hunoter-ll/WhatsAsena.git
cd WhatsAsena
npm i
